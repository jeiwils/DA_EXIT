...
from DA_EXIT.representations_indexing.a3_representations import (
    dataset_rep_paths,
    get_embedding_model,
    load_faiss_index,
)
from DA_EXIT.representations_indexing.a3_representations.sparse_representations import SPACY_MODEL
from DA_EXIT.representations_indexing.a2_indexing.retrieval_indexing import _retrieve_chunk_indices
from DA_EXIT.sentence_extraction_reranking.b2_reranking.useful_sentence_extractor_lora import (
    DEFAULT_MAX_LEN,
    encode_batch,
    select_ranked_sentences,
)
from DA_EXIT.representations_indexing.b1_retrieval import DEFAULT_HYBRID_ALPHA
from DA_EXIT.sentence_extraction_reranking.c1_reasoning.sentence_reasoning import (
    _build_sentence_candidates,
    _select_top_sentences,
    compute_passage_hits_recall_at_k,
    compute_passage_precision_at_k,
)
from DA_EXIT.sentence_extraction_reranking.c2_generation.answer_gen import ask_llm_with_passages
from DA_EXIT.metrics.d1_evaluation.answer_metrics import aggregate_answer_scores, evaluate_answers
from DA_EXIT.metrics.d1_evaluation.timing_metrics import compute_throughput_stats, wall_time
from DA_EXIT.preprocessing_ingestion.utils.__utils__ import (
    append_jsonl,
    compute_resume_sets,
    data_path,
    get_result_paths,
...
TAU_LOW = 0.81 # CHANGE THIS TO TAU_THRESHOLD 
...
SENTENCE_GRADER_MODEL = str(
    data_path(
        "models",
        "useful_sentence_lora",
        "grid",
        "run4_hn6_rn1_pw2.0_lr3e-05_ep8_r8_a16_d0.05_bs16",
        "checkpoint-epoch8",
    )
)
...
def main() -> None:
    ...
    Expects processed datasets under DA_EXIT/data/processed_datasets and
    precomputed chunk representations under DA_EXIT/data/representations/datasets.
    """
