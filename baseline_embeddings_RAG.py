...
from DA_EXIT.metrics.d1_evaluation.answer_metrics import (
    aggregate_answer_scores,
    evaluate_answers,
)
from DA_EXIT.metrics.d1_evaluation.retrieval_metrics import (
    compute_hits_at_k,
    compute_precision_at_k,
    compute_recall_at_k,
)
from DA_EXIT.metrics.d1_evaluation.timing_metrics import (
    compute_throughput_stats,
    summarize_reader_wall_times,
    wall_time,
)
from DA_EXIT.metrics.d1_evaluation.usage_metrics import merge_token_usage
...
def run_baseline_rag(
    ...
    reader_model: str
        ...
        :func:`DA_EXIT.preprocessing_ingestion.utils.__utils__.get_server_configs` for this model when ``None``.
    ...
    resume: bool, optional
        ...
        :func:`DA_EXIT.preprocessing_ingestion.utils.__utils__.compute_resume_sets` determines which question IDs
        have been completed.
