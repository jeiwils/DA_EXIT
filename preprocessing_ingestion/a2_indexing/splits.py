...
from DA_EXIT.preprocessing_ingestion.utils.__utils__ import load_jsonl, processed_dataset_paths
...
def carve_validation_split(
    ...
    *,
    ...
    ``DA_EXIT/data/processed_datasets/{dataset}/{train_split}/`` and
    ``DA_EXIT/data/processed_datasets/{dataset}/{val_split}/``.
    """
